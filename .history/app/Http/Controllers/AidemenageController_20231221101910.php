...
class AidemenageController extends Controller
{
    ...
    {
        return view('backoffice.aidemenage', [$aidemenages => Aidemenage::all(), $foyers => Foyer::all()]);
    }  
    ...
    public function store(AidemenageRequest $request)
{
    ...
    //         abort(404, 'menagère non trouvé');
    //     }
    
    //     // Affiche la vue 'auth.edit' avec les données de l'utilisateur
    //     return view('backoffice/liste_menagere', compact('aidemenages'));
    // }
}
