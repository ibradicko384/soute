                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('aidemenage.store') }}">
                        ...
                        <div class="form-group">
                            <label for="nom_Aidemenage">Nom</label>
                            <input id="nom_Aidemenage" type="text" class="form-control" name="nom_Aidemenage" required autofocus>
                            @error('nom_Aidemenage')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            <label for="prix_Aidemenage">Prenom</label>
                            <input id="prix_Aidemenage" type="text" class="form-control" name="prix_Aidemenage" required autofocus>
                            @error('prix_Aidemenage')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            <label for="description_Aidemenage">Date de naissance</label>
