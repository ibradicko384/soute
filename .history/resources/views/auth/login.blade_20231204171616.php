...
@section('body')
<section class="container shadow-lg p-4 mb-5 rounded bg-white mt-5 pb-3">
        @if ($adminCount === 0)
                ...
                <div class="alert alert-warning">
                   <h5> Aucun administrateur n'est enregistré. Veuillez inscrire un administrateur avant de vous connecter.</h5>
                    <a href="{{ route('register_admin') }}" class="btn btn-red ml-5">Inscrire l'administrateur</a>
                </div>
         @endif
        <div class="row d-flex page_login">
            <div class="container pt-3 col-lg-8">
                <img src="{{ asset('images/image2.jpg') }}" width="300px" alt="logo" class="img-fluid">
            </div>
            <div class="container shadow-lg p-3 mb-5 rounded pt-5 col-lg-4 bg-primary">   
                <h2 class="text-white">Veuillez vous identifier</h2>
                <form method="post" action="{{ route('login_admin') }}" class="pt-5">
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label text-white" for="remember_me">Se souvenir de moi</label>
                    </div>
                    <br>  
                    ...
                    @endif
                    <div class="pt-2">
                        <button type="submit" name="connecter" class="btn btn-info">
                            Se connecter
                        </button>
                    </div>
                </form>
