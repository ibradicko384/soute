...
<section class="container mt-5 pb-3">
        ...
        <div class="row d-flex page_login">
            ...
            <div class="container pt-5 col-lg-4">   
                <h2 class="text-primary">Veuillez vous identifier</h2>
                <form method="post" action="{{ route('login_admin') }}" class="pt-5">
                    @csrf
                    <div class="input-container">
                        <input placeholder="Email"  id="email" class="form-control" type="password" name="password" required autocomplete="current-password">
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label text-primary" for="remember_me">Se souvenir de moi</label>
                    </div>
                    <br>  
