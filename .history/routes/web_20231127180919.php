...
Route::get('/register-admin', [App\Http\Controllers\Auth\RegisteredAdminController::class, 'create'])->name('register_admin');
Route::get('/login-admin', [AuthenticatedSessionAdminController::class, 'create'])->name('login_admin');
Route::get('/login-admin', [App\Http\Controllers\Auth\RegisteredAdminController::class, 'login'])->name('login_admin');
