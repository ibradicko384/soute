...
Route::get('/backoffice/liste_menagere', [AidemenageController::class, 'ListeMenagere'])->name('liste_menagere');
// Route::get('/backoffice/menagere/{id}/edit', [AidemenageController::class, 'edit'])->name('editmenage');
...
Route::get('/backoffice/foyer/{foyer}', [FoyerController::class, 'foyer'])->name('foyer.show');
Route::post('/backoffice/foyer', [FoyerController::class, 'store'])->name('backoffice.foyer');
