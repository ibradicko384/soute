...
use App\Http\Controllers\VerificationController;
    ...
    Route::get('/backoffice/admin-register-', [RegisteredAdminController::class, 'create'])->name('register_admin');
    Route::post('/backoffice/register-admin', [RegisteredAdminController::class, 'store']);
