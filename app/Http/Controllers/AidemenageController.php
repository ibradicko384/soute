    ...
    public function store(AidemenageRequest $request)
{
    ...
    public function AidePublicAidesMenageres()
    {
        $aidesMenageres = Aidemenage::all();
        return view('backoffice.menagere', compact('aidesMenageres'));
    }

    public function ListeMenagere()
    {
        return view('liste_menagere');
    }
    ...
    public function lister(Request $request)
    {
        ...
        return view('backoffice.list_aidemenage', compact('aidemenages', 'foyers', 'selectedFoyer'));
    }
}
